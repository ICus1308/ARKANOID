...
public class LevelManager extends GamePlay {
    ...
    private Brick createBrick(char typeChar, double x, double y, double brickWidth, Pane root) {
        ...
        switch (typeChar) {
            case '1':
                newBrick = new BStandardBrick(x, y, brickWidth, BRICK_HEIGHT);
                break;
            case '2':
                newBrick = new BMultiHitBrick(x, y, brickWidth, BRICK_HEIGHT);
                break;
            case 'U':
                newBrick = new BIndestructibleBrick(x, y, brickWidth, BRICK_HEIGHT);
                break;
            case '5':
                newBrick = new BMultiHitBrick(x, y, brickWidth, BRICK_HEIGHT, 5);
                break;
            case 'B':
                BExplodingBrick explodingBrick = new BExplodingBrick(x, y, brickWidth, BRICK_HEIGHT);
