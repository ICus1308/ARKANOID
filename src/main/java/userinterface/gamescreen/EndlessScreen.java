...
public class EndlessScreen extends UIManager implements GameScreen {
    ...
    protected void initializeUI() {
        ...
        coinsBox.setLayoutX(GAME_WIDTH / 2 - 150);
        ...
        root.getChildren().addAll(scoreText, livesBox, coinsBox, levelText, gameMessage);
    }
    ...
    public void cleanup() {
        if (root != null) {
            root.getChildren().removeAll(scoreText, livesBox, coinsBox, levelText, gameMessage);
        }
    }
}
